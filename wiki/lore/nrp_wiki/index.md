...
!button[
    /wiki/lore/nrp_wiki/elid
    Информация об ELID
]

!button[
    /wiki/lore/nrp_wiki/organisations/SPF
    О Ч.В.К. S.P.F.
]

!button[
    /wiki/lore/nrp_wiki/organisations
    Об организациях
]

!button[
    /wiki/lore/nrp_wiki/t_doll_index
    Индексы тактических кукл
]
